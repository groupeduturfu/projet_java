...
public class SSH {
     ...
     */
    public SSH(String username, String password, String firstHost, String secondHost, int firstHostPort, int secondHostPort) {
     ...
     * @param password Mot de passe ECE
     */
    public SSH (String username, String password) {
        this.username = username;
        this.password = password;
    }
