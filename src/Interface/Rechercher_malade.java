...
public class Rechercher_malade {
    ...
    private static JTextField jtf_no_id, jtf_nom, jtf_prenom, jtf_no_chambre, jtf_no_lit, jtf_datea, jtf_adresse, jtf_tel, jtf_mutuelle;
    private Connexion maconnexion;
    private static ArrayList<ArrayList<String>> liste;
    
    public Rechercher_malade(JFrame f) {
        ...
        valider.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (jtf_no_id.getText().equals("")) {
                    ...
                    id_recu = Integer.parseInt(jtf_no_id.getText().trim());
                }
                // nom
                ...
                if (jtf_datea.getText().equals("")) {
                    ...
                    date_arrivee_recu = jtf_datea.getText();
                }
                //adresse
    ...
    public static Rechercher_malade getFenetre(JFrame f) {
        fenetre = new Rechercher_malade(f);
        return fenetre;
    }
}